...
export const AUTH_UK: AuthStrings = {
  ...
  landingTrustTitle: 'Австрійські податки без сюрпризів',
  landingTrustBody:
    'Режим для самозайнятих враховує внески SVS і податок на дохід. Звіт про доходи й витрати можна експортувати одним кліком — для себе або податкового консультанта.',
