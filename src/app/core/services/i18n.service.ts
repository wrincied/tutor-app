...
const AUTH: Record<Lang, AuthStrings> = {
  ru: {
    ...
    landingTrustTitle: 'Австрия без сюрпризов в налогах',
    landingTrustBody:
      'Режим для самозанятых учитывает взносы SVS и подоходный налог. Отчёт по доходам и расходам можно выгрузить в один клик — для себя или налогового консультанта.',
  ...
  en: {
    ...
    landingTrustTitle: 'Austria-ready tax view',
    landingTrustBody:
      'Self-employed mode factors in SVS contributions and income tax. Export income and expense reports in one click — for you or your tax advisor.',
  ...
  de: {
    ...
    landingTrustTitle: 'Österreichische Steuern im Blick',
    landingTrustBody:
      'Der Modus für Selbstständige berücksichtigt SVS-Beiträge und Einkommensteuer. Einnahmen und Ausgaben lassen sich mit einem Klick exportieren — für Sie oder Ihren Steuerberater.',
  ...
  kz: {
    ...
    landingTrustTitle: 'Австрия салығына дайын көрініс',
    landingTrustBody:
      'Өзін-өзі жұмыспен қамту режимі SVS жарналары мен табыс салығын есептейді. Табыс пен шығын есебін бір рет басып шығаруға болады.',
