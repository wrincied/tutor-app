...
const AUTH: Record<Lang, AuthStrings> = {
  ...
  de: {
    ...
    landingFeatureScheduleBody:
      'Planen Sie Stunden, Wiederholungen und Status — ohne Chaos in Notizen und Chats.',
...
const STUDENTS: Record<Lang, StudentStrings> = {
  ...
  de: {
    ...
    billingInfoPackage:
      'Abo: Sie tragen ein, wie viele Stunden bereits bezahlt sind. Nach jeder abgeschlossenen Stunde wird eine Einheit vom Guthaben abgezogen.',
    billingInfoPostpaid:
...
const HOME: Record<Lang, HomeStrings> = {
  ...
  de: {
    ...
    nextLessonTitle: 'Nächste Stunde',
    nextLessonNone: 'Alle heutigen Stunden sind erledigt oder nicht geplant',
    todayAgenda: 'Heutiger Plan',
    overdueLessonsHint: '{count} Stunde(n) nicht als durchgeführt markiert',
